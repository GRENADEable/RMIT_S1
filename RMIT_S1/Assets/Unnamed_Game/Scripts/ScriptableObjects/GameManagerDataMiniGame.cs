...
namespace Khatim_F2
{
    [CreateAssetMenu(fileName = "GameManagerMiniGame_Data", menuName = "Managers/GameManagerMiniGameData")]
    public class GameManagerDataMiniGame : ScriptableObject
    {
        #region Public Variables
        [Space, Header("Enums")]
        public GameState currState = GameState.Game;
        public enum GameState { Menu, Intro, Starting, Game, Paused, Outro, End };
        #endregion
